...
class MyHouse{
 ...
 function get_Bedroom() {     
  ...
  function get_Area() {     
    ...
    echo "<br>";
    $house2 = new MyHouse("blue"); 
	$house2->SetHouseName("a"); 
	$house2->set_Bedroom(4); 
	$house2->set_color("green");  
	$house2->set_style("British country");  
	$house2->set_Bathroom(3);  
	$house2->set_Area(20, 20);  
